...
class SLN_Metabox_Booking extends SLN_Metabox_Abstract
{
    ...
    public function add_meta_boxes()
    {
        ...
        add_meta_box(
            $pt.'-details',
            __('Detalii rezervare', 'salon-booking-system'),
    ...
    private function validate($values)
    {
        ...
        if (isset($_POST['_sln_booking_createuser']) && $_POST['_sln_booking_createuser']) {
            if (empty($values['_sln_booking_email'])) {
                $this->addError(__('e-mail nu poate fi lpc gol', 'salon-booking-system'));
            }
            if (empty($values['_sln_booking_phone'])) {
                $this->addError(__('Telefonul mobil nu poate fi loc gol', 'salon-booking-system'));
            }
        }
