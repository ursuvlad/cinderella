...
<div class="sln-box--sub row">
    <div class="col-xs-12">
        <h2 class="sln-box-title"><?php _e('SMS Test consola', 'salon-booking-system') ?><span><?php _e(
                    'completati cimpurile si setarile de actualizare',
                    'salon-booking-system'
                ) ?></span></h2>
    </div>
    <div class="col-sm-4 form-group sln-input--simple">
        <?php $helper->row_input_text('sms_test_number', __('Numar', 'salon-booking-system')); ?>
    </div>
    <div class="col-sm-4 form-group sln-input--simple">
        <?php $helper->row_input_text('sms_test_message', __('Mesaj', 'salon-booking-system')); ?>
    </div>
    <div class="col-sm-6 col-md-4 sln-box-maininfo  align-top">
        <p class="sln-input-help"><?php _e(
                'Utilizati aceasta consola doar pentru a testa Serviciul SMS. Se umple numărul de destinatie fara codul de tara, scrie un mesaj si fa click "Actualizare setari" trimite un SMS.',
                'salon-booking-system'
            ); ?></p>
    </div>
</div>
