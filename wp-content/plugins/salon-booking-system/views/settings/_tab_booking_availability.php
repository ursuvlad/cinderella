...
?>
<h2 class="sln-box-title"><?php _e('Mod de disponibilitate','salon-booking-system');?> <span><?php _e('Selectati modul si sistemul de rezervare preferat.', 'salon-booking-system') ?></span></h2>
<div class="row">
