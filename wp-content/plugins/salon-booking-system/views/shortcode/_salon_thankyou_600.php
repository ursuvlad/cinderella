<div class="col-md-12">
    ...
    <?php if (isset($payOp) && $payOp == 'cancel'): ?>
        ...
        <div class="alert alert-danger">
            <p><?php _e('Plata nu a reușit, vă rugăm să încercați din nou.', 'salon-booking-system') ?></p>
        </div>

    <?php else: ?>
        <div class="row sln-thankyou--okbox <?php if($confirmation): ?> sln-bkg--attention<?php else : ?> sln-bkg--ok<?php endif ?>">
            <div class="col-md-12">
                <h1 class="sln-icon-wrapper"><?php echo $confirmation ? __('Rezervarea dvs. este in asteptare', 'salon-booking-system') : __('Rezervarea dvs. este finalizata', 'salon-booking-system') ?>
                    <?php if($confirmation): ?>
