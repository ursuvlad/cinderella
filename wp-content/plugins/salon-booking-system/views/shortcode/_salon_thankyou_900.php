<div class="col-md-8">
    <?php if($confirmation) : ?>
        <h2 class="salon-step-title"><?php _e('Starea de rezervare', 'salon-booking-system') ?></h2>
    <?php else : ?>
    ...
    <?php else: ?>
        <div class="row sln-thankyou--okbox <?php if($confirmation): ?> sln-bkg--attention<?php else : ?> sln-bkg--ok<?php endif ?>">
            ...
            <div class="col-md-12">
                <h2 class="salon-step-title"><?php _e('Numarul de rezervare', 'salon-booking-system') ?></h2>
