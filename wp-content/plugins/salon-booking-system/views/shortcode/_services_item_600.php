...
<?php endif ?>
            ...
            <div class="col-sm-10 col-md-9">
                <label for="<?php echo SLN_Form::makeID('sln[services][' . $service->getId() . ']') ?>">
                    ...
                    <?php if ($service->getDuration()->format('H:i') != '00:00'): ?>
                        <span class="sln-steps-duration sln-service-duration"><small><?php echo __('Durata', 'salon-booking-system')?>:</small> <?php echo $service->getDuration()->format(
                                'H:i'
                            ) ?></span>
                    <?php endif ?>
                </label>
    ...
    <div class="row">
        ...
        <div class="col-md-11">
                ...
                <?php endforeach ?>
                    <div class="sln-alert sln-alert-medium sln-alert--problem" style="display: none" id="availabilityerror"><?php _e('Nu este suficient timp pentru acest serviciu','salon-booking-system') ?></div>
                </span>
        </div>
    </div>
</div>
