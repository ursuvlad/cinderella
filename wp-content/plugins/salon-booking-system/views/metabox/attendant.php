...
<div class="row sln-service-price-time">
    ...
    <div class="col-sm-6 col-md-3 form-group sln-select">
            <label for="_sln_attendant_phone"><?php echo __('telefon mobil', 'salon-booking-system') ?></label>
    ...
    <div class="col-sm-12 col-md-6 form-group sln-select sln-select--multiple">
            <label><?php echo __('Servicii', 'salon-booking-system') ?></label>
            <select class="sln-select select2-hidden-accessible" multiple="multiple" data-placeholder="<?php _e('Selectati sau cautati unul sau mai multe servicii')?>"
