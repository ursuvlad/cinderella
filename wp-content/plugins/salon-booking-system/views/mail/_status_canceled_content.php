        ...
        <table width="502" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td align="left" valign="top"
                    style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#666666; font-weight:normal;">
<p>
<?php echo __('Drag', 'salon-booking-system') . ' ' . $booking->getDisplayName() . ','; ?>
</p>

<p>
                        <?php echo __('urmatoarea rezervare la ' . $plugin->getSettings()->get('gen_name') . ' a fost anulata', 'salon-booking-system') ?>.</p>
                </td>
            </tr>
            <tr>
                <td align="left" valign="top">&nbsp;</td>
            ...
            <tr>
                <td align="center" valign="top"><table width="460" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tbody><tr>
                            <td width="242" align="left" valign="middle" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#cc3333; font-weight:normal;"><?php echo __('Adresa noastra', 'salon-booking-system') ?></td>
            ...
            <tr>
                <td align="center" valign="top" bgcolor="#ffffff"><table width="460" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tbody><tr>
                            <td width="242" align="left" valign="middle" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#cc3333; font-weight:normal;"><?php echo __('Contacte', 'salon-booking-system')?></td>
