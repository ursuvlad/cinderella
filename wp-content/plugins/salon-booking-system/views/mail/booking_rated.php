...
$data['subject'] = __('Rezervare a fost evaluata','salon-booking-system');
...
?>
	...
	<tr style="font-family: Arial, Helvetica, sans-serif; color: #888;">
		<td height="105" valign="middle" bgcolor="#f2f2f2">
			<p style="margin-left: 49px; margin-right: 49px;"><?php _e('Draga administrator,','salon-booking-system') ?></p>
			<p style="margin-left: 49px; margin-right: 49px;">
				<?php
				_e('acest client','salon-booking-system');
				$usermeta = get_user_meta($booking->getUserId());
				echo ' ' . $usermeta['first_name'][0] . ' ' . $usermeta['last_name'][0] . ' ';
				_e('a lasat un comentariu nou in urma vizitei sale','salon-booking-system');
